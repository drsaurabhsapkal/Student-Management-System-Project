		...
		<div class="container col-lg-4 p-3 mt-4 shadow-lg rounded text-black opct">	
			<form action="#" method="post" >
				...
				<div class="col mt-2">
					...
					<a href="../student/index.php"><button type="button" class="btn btn-warning"><< Back to Login</button></a>
				</div> 
			</form>
		</div>
    </body>
			...
			if($password==$cpassword){
				...
				if($result){
					if(mysqli_num_rows($result)>0){
						...
						$query = "INSERT INTO user values('default','$username','$email','$add','$mnumber','$password','$gender')";
						$result = mysqli_query($conn,$query);
						if($result){
